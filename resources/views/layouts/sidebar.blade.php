            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="users">@lang('Users')</a></li>
                        <li><a href="roles">@lang('Roles')</a></li>
                        <li><a href="tables-responsive3">@lang('Access')</a></li>
                           @can('menu-permission')
            
           
                        <li><a href="permissions">@lang('Permissions')</a></li> @endcan
                    </ul>
                </li>
                ...
                {{-- <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="tables-responsive1">@lang('User')</a></li>
                        <li><a href="tables-responsive2">@lang('Groups')</a></li>
                        <li><a href="tables-responsive3">@lang('Access')</a></li>
...
<li>
                ...
                {{-- <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="sync">@lang('Category Products')</a></li>
                        <li><a href="sync">@lang('Products')</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="sync">@lang('Cart')</a></li>
                        <li><a href="sync">@lang('Orders')</a></li>
                        <li><a href="sync">@lang('Sync Vend')</a></li>
                        <li><a href="sync">@lang('Sync Email Vend')</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        ...
                        <li><a href="sync">@lang('Sync Vend Get Trans')</a></li>
                        <li><a href="sync">@lang('Sync Vend')</a></li>
                        <li><a href="sync">@lang('Sync Email Vend')</a></li>
                    </ul>
                </li>
